...
const Register = () => {
  ...
  const handleRegister = async(data) => {
    ...
    await axios.post("http://localhost:4001/api/v1/user/register", data, {
  ...
  <div>
    ...
    <div className="verification-method">
      ...
      <div className="wrapper">
        <label>
          <input type="radio" name="verification-method" value={"email"} {...register("verificationMethod")} required />Email
        </label>
        <label>
          <input type="radio" name="verification-method" value={"phone"} {...register("verificationMethod")} required />Phone
        </label>
      </div>
    </div>
